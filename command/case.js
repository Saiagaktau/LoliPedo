...
if (anu.action == 'add' && !mem.includes(haruka.user.jid)) {
			...
			//fake reply
			let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `${botname} ðŸŸï¸\nBy ${ownername}`, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}},sendEphemeral: true}
	        ...
	        let fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`Â© ${ownername}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${botname} ðŸŸï¸\nBy ${ownername}`, 'jpegThumbnail': thumbnail}}}
...
haruka.sendMessage(from, buffer, video, {mimetype: 'video/mp4', quoted: mek, caption: 'ɪᴹ᭄✿ 𝐟𝐢𝐫𝐚𝐚 Ᏼo͢Ꭲ'})
break
case 'tiktokwm':
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
reply(lang.wait())
...
if (!isHaruka) return sendButMessage(from, lang.noregis(pushname), `Klik Button Untuk Verify`, [{buttonId: '.daftar',buttonText: {displayText: `Daftar`,},type: 1,}], {quoted: fgif});
    	  ...
    	  const ab = await haruka.prepareMessage(from, fs.readFileSync(`./${sender}.jpeg`), MessageType.image)
            ...
            contentText: `_© By ɪᴹ᭄✿ 𝐟𝐢𝐫𝐚𝐚 Ᏼo͢Ꭲ_`,
...
const bulonss = [{buttonId:`.${command}`,buttonText: {displayText: 'Next'}, type: 1}]
            const Bsessages = {
            contentText: `_© By ɪᴹ᭄✿ 𝐟𝐢𝐫𝐚𝐚 Ᏼo͢Ꭲ`,
            buttons: bulonss,
            footerText: `Klik Next Untuk Melanjutkan`,
            headerType: 4,
